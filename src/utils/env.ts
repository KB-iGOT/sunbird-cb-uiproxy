...
export const CONSTANTS = {
  ...
  CASSANDRA_LOCAL_DC: env.CASSANDRA_LOCAL_DC || 'datacenter1',
  CASSANDRA_MAX_CONN_LOCAL: Number(env.CASSANDRA_MAX_CONN_LOCAL) || 8,
  CASSANDRA_MAX_CONN_REMOTE: Number(env.CASSANDRA_MAX_CONN_REMOTE) || 2,
