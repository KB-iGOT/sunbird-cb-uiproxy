...
export const CONSTANTS = {
  ...
  CASSANDRA_IP: env.CASSANDRA_IP || 'localhost',
  ...
  SERVING_HOST_COUNTER_URL: env.SERVING_HOST_COUNTER_URL,
  ...
  SAML_SP_REDIRECT_PATH: env.SAML_SP_REDIRECT_PATH || '/protected/v8/resource/?auth_callback=1',
  SAML_SP_IDP_HINT_PARAM: env.SAML_SP_IDP_HINT_PARAM || 'kc_idp_hint',
  SAML_SP_DEFAULT_IDP: env.SAML_SP_DEFAULT_IDP || 'sbi',
