jest.mock('../../src/protectedApi_v8/protectedApiV8', () => {
...
jest.mock('../../src/proxies_v8/proxies_v8', () => {
  // tslint:disable-next-line: no-var-requires
  const expressLib = require('express')
  const router = expressLib.Router()
...
jest.mock('../../src/publicApi_v8/publicApiV8', () => {
  // tslint:disable-next-line: no-var-requires
  const expressLib = require('express')
  const router = expressLib.Router()
...
jest.mock('../../src/authoring/authContent', () => {
  // tslint:disable-next-line: no-var-requires
  const expressLib = require('express')
  const router = expressLib.Router()
...
jest.mock('../../src/authoring/authNotification', () => {
  // tslint:disable-next-line: no-var-requires
  const expressLib = require('express')
  const router = expressLib.Router()
...
jest.mock('../../src/authoring/authIapBackend', () => {
  // tslint:disable-next-line: no-var-requires
  const expressLib = require('express')
  const router = expressLib.Router()
...
jest.mock('../../src/authoring/authSearch', () => {
  // tslint:disable-next-line: no-var-requires
  const expressLib = require('express')
  const router = expressLib.Router()
...
jest.mock('../../src/authoring/content', () => {
  // tslint:disable-next-line: no-var-requires
  const expressLib = require('express')
  const router = expressLib.Router()
...
jest.mock('../../src/configs/session.config', () => ({
...
jest.mock('../../src/utils/apiWhiteList', () => {
...
jest.mock('../../src/utils/custom-keycloak', () => {
...
// tslint:disable-next-line: no-var-requires
const { __whitelistState } = require('../../src/utils/apiWhiteList')
// tslint:disable-next-line: no-var-requires
const { __keycloakAuthState } = require('../../src/utils/custom-keycloak')
