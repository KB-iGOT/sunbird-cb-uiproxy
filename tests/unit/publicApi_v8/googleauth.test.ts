jest.mock('../../../src/publicApi_v8/googleOAuthHelper', () => ({
...
import { googleAuth } from '../../../src/publicApi_v8/googleauth'
import { getGoogleProfile } from '../../../src/publicApi_v8/googleOAuthHelper'
