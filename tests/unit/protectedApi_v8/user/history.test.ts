...
jest.mock('../../../../src/protectedApi_v8/content', () => ({ getContentDetails: jest.fn() }))

import axios from 'axios'
import express, { NextFunction, Request, Response } from 'express'
import supertest from 'supertest'
import { getContentDetails } from '../../../../src/protectedApi_v8/content'
import { historyApi } from '../../../../src/protectedApi_v8/user/history'
