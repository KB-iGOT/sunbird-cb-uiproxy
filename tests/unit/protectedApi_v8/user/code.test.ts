...
import { checkForBlockedStatement, codeApi, execute, verifySubmit, viewLastSubmission } from '../../../../src/protectedApi_v8/user/code'
...
describe('checkForBlockedStatement', () => {
  ...
  it('returns a rejection payload when a restricted python statement is present', () => {
    // tslint:disable-next-line: no-any
    const originalRestricted = require('../../../../src/utils/env').RESTRICTED_PYTHON_STMT as string[]
