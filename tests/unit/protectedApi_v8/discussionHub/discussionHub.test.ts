jest.mock('../../../../src/protectedApi_v8/discussionHub/posts', () => {
...
jest.mock('../../../../src/protectedApi_v8/discussionHub/topics', () => {
  // tslint:disable-next-line: no-var-requires
  const expressLib = require('express')
  const router = expressLib.Router()
...
jest.mock('../../../../src/protectedApi_v8/discussionHub/tags', () => {
  // tslint:disable-next-line: no-var-requires
  const expressLib = require('express')
  const router = expressLib.Router()
...
jest.mock('../../../../src/protectedApi_v8/discussionHub/categories', () => {
  // tslint:disable-next-line: no-var-requires
  const expressLib = require('express')
  const router = expressLib.Router()
...
jest.mock('../../../../src/protectedApi_v8/discussionHub/notifications', () => {
  // tslint:disable-next-line: no-var-requires
  const expressLib = require('express')
  const router = expressLib.Router()
...
jest.mock('../../../../src/protectedApi_v8/discussionHub/users', () => {
  // tslint:disable-next-line: no-var-requires
  const expressLib = require('express')
  const router = expressLib.Router()
...
jest.mock('../../../../src/protectedApi_v8/discussionHub/writeApi', () => {
  // tslint:disable-next-line: no-var-requires
  const expressLib = require('express')
  const router = expressLib.Router()
...
import { discussionHubApi } from '../../../../src/protectedApi_v8/discussionHub/discussionHub'
