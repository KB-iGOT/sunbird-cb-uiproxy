jest.mock('../../../../src/protectedApi_v8/admin/banner', () => {
...
jest.mock('../../../../src/protectedApi_v8/admin/userRegistration', () => {
  // tslint:disable-next-line: no-var-requires
  const expressLib = require('express')
  const router = expressLib.Router()
...
jest.mock('../../../../src/protectedApi_v8/admin/userRoles', () => {
  // tslint:disable-next-line: no-var-requires
  const expressLib = require('express')
  const router = expressLib.Router()
...
import { admin } from '../../../../src/protectedApi_v8/admin/admin'
