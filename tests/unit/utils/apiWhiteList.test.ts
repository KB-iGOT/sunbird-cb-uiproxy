jest.mock('../../../src/utils/whitelistApis', () => ({
  API_LIST: {
    URL: {
...
import { apiWhiteListLogger, isAllowed } from '../../../src/utils/apiWhiteList'
import { deauthenticateKeycloakSession } from '../../../src/utils/custom-keycloak'
