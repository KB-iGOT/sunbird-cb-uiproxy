...
jest.mock('../../../../../src/authoring/utils/read-meta-and-json/channel', () => ({ extractChannelData: jest.fn() }))
...
import { extractWebModuleData, readJSONData } from '../../../../../src/authoring/utils/read-meta-and-json/index'
